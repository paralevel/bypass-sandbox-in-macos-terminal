...
Looks like it has a permanent effect and it also makes all other files and subdirectories in that specific directory accessible to the current user (unlike Full Disk Access which implicates all users)
