...
Seems to have a permanent effect and also makes all other files and subdirectories in the same directory accessible to the current user, unlike Full Disk Access which goes into effect for all users
